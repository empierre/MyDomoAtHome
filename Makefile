# This Makefile is for the Domo extension to perl.
#
...
#     NAME => q[Domo]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML=>q[0], Dancer=>q[1.3095] }
#     VERSION_FROM => q[lib/Domo.pm]
#     clean => { FILES=>q[Domo-*] }
...
TO_INST_PM = lib/Domo.pm \
	lib/MySensors.pm \
	lib/MySensorsMSG.pm \
	lib/schema.sql

PM_TO_BLIB = lib/schema.sql \
	blib/lib/schema.sql \
	lib/Domo.pm \
	blib/lib/Domo.pm \
	lib/MySensors.pm \
	blib/lib/MySensors.pm \
	lib/MySensorsMSG.pm \
	blib/lib/MySensorsMSG.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Domo' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.5">' > $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/schema.sql blib/lib/schema.sql \
	  lib/Domo.pm blib/lib/Domo.pm \
	  lib/MySensors.pm blib/lib/MySensors.pm \
	  lib/MySensorsMSG.pm blib/lib/MySensorsMSG.pm 
