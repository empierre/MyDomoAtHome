...
# Default-Stop:         0 1 6
# Short-Description:    MyDomoAtHome
# Description:          MyDomoAtHome ISS gateway to Imperihome from Domoticz
### END INIT INFO
#
...
APPLICATION_PATH="/home/pi/domoticz/MyDomoAtHome/mdah.js"
# Process ID file path.
PIDFILE="/tmp/mdah.pid"
# Log file path.
LOGFILE="/tmp/mdah.log"
