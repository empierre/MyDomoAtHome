...
perl -pi -e "s/RUN wget.*/RUN wget http://www.e-nef.com/domoticz/mdah/node-mydomoathome-${ver}.deb/g" Dockerfile
perl -pi -e "s/RUN dpkg -i node-mydomoathome.*/RUN dpkg -i node-mydomoathome-${ver}.deb/g" Dockerfile
